  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <div className="flex justify-between items-center boton">
       ...
       <Link to='/complete-booking' className="bg-gray-200 w-full text-center cursor-pointer border border-gray-300 hover:border hover:border-gray-300 font-bold py-2">Complete Booking </Link>
            ...
            onClick={(e) => {
              ...
              axios.post(baseUrl +  'api/v1/admin/dayBookingList',dayData,{
                ...
                if (respo.data.responseCode === 200) {
                  ...
                  alert('No complete booking in last 7 days')
                }
              })
            ...
            onClick={(e) => {
              ...
              axios.post(baseUrl +  'api/v1/admin/dayBookingList',dayData,{
                ...
                if (respo.data.responseCode === 200) {
                  ...
                  alert('No complete booking in last 15 days')
                }
              })
            ...
            onClick={(e) => {
              ...
              axios.post(baseUrl +  'api/v1/admin/dayBookingList',dayData,{
                ...
                if (respo.data.responseCode === 200) {
                  ...
                  alert('No complete booking in last 30 days')
                }
              })
...
export default CompleteDateWise;
