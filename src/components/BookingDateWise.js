...
function BookingDateWise() {
 ...
 if (fromDate && toDate) {
  ...
  const dateSubmit = async() => {
    const response = await fetch(baseUrl + "api/v1/admin/bookinglistforAdmin", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <div className="flex justify-between items-center boton">
       <Link to='/booking' className="bg-gray-200 w-full text-center cursor-pointer border border-gray-300  hover:border hover:border-gray-300 font-bold py-2">All Booking </Link>
            ...
            onClick={(e) => {
              ...
              axios.post(baseUrl +  'api/v1/admin/dayBookingList',dayData,{
                ...
                if (respo.data.responseCode === 200) {
                  ...
                  alert('No booking in last 7 days')
                }
              })
            ...
            onClick={(e) => {
              ...
              axios.post(baseUrl +  'api/v1/admin/dayBookingList',dayData,{
                ...
                if (respo.data.responseCode === 200) {
                  ...
                  alert('No booking in last 15 days')
                }
              })
            ...
            onClick={(e) => {
              ...
              axios.post(baseUrl +  'api/v1/admin/dayBookingList',dayData,{
                ...
                if (respo.data.responseCode === 200) {
                  ...
                  alert('No booking in last 30 days')
                }
              })
...
export default BookingDateWise;
