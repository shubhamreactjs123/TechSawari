            ...
            onClick={(e) => {
              ...
              axios.post(baseUrl +  'api/v1/admin/dayBookingList',dayData,{
                ...
                if (respo.data.responseCode === 200) {
                  ...
                  alert('No cancel booking in last 7 days')
                }
              })
            ...
            onClick={(e) => {
              ...
              axios.post(baseUrl +  'api/v1/admin/dayBookingList',dayData,{
                ...
                if (respo.data.responseCode === 200) {
                  ...
                  alert('No cancel booking in last 15 days')
                }
              })
            ...
            onClick={(e) => {
              ...
              axios.post(baseUrl +  'api/v1/admin/dayBookingList',dayData,{
                ...
                if (respo.data.responseCode === 200) {
                  ...
                  alert('No cancel booking in last 30 days')
                }
              })
